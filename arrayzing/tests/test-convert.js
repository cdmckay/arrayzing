...
{    
    ...
    var a = _(array).boolize(-1);
    var b = _(array).boolize();
    ...
    equals(_(overload).boolize().join(), "true,false", "See if the toBoolean is detected and used properly");
});
...
test("Test numberize().", function()
{
    ...
    var overload = [object1, object2];
    var a = _(array).numberize(-1);
    var b = _(array).numberize();
    ...
    equals(_(overload).numberize().join(), "1,2", "See if the toNumber is detected and used properly");
});
...
test("Test strize().", function()
{
    ...
    var array = [1, "str", 0, null, "false", "$2", true];
    var overload = [object1, object2];
    var a = _(array).strize(-1);
    var b = _(array).strize();
    ...
    equals(_(overload).strize().join(), "object1,object2", "See if the toString is detected and used properly")
});
